 ...
 * is displayed and the EditTextPreference is not dismissed
 */
public class ValidatingEditTextPreference extends EditTextPreference {
	...
	private final class ValidatingOnClickListener implements View.OnClickListener, OnEditorActionListener {
